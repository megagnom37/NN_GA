...
NUM_GENERATION = 1000
NUM_PARENT_NETWORKS = 7
CHILDREN_PER_PARENT = 2
NUM_MUTATION_WEIGHTS = 20000
MUTATION_FACTOR = np.float32(0.1)
MAX_REWARD = 500
RANDOM_SELECTED_NETWORKS = 2
NUM_STARTS_FOR_AVRG = 5
...
def generate_model(input_size):
    ...
    model.add(layers.Conv2D(16, (8, 8), activation='relu',
                            input_shape=input_size, strides=(2, 4), padding='same'))
    # model.add(layers.MaxPooling2D((2, 2)))
    model.add(layers.Conv2D(32, (4, 4), activation='relu', strides=(2, 3), padding='valid'))
    model.add(layers.Conv2D(64, (3, 3), activation='relu', strides=(2, 2), padding='valid'))
    model.add(layers.Conv2D(64, (3, 3), activation='relu', strides=(2, 2), padding='valid'))
    # model.add(layers.MaxPooling2D((2, 2)))
    # model.add(layers.Conv2D(32, (4, 4), activation='relu', strides=(2, 2), padding='valid'))
    # model.add(layers.Conv2D(32, (3, 3), activation='relu', strides=(1, 2), padding='valid'))
    # model.add(layers.MaxPooling2D((2, 2)))
    # model.add(layers.Conv2D(32, (3, 3), activation='relu'))
    # model.add(layers.MaxPooling2D((2, 2)))

    # model.add(layers.Conv2D(16, (3, 3), activation='relu',input_shape=input_size))
    # model.add(layers.MaxPooling2D((2, 2)))
    # model.add(layers.Conv2D(32, (3, 3), activation='relu'))
    # model.add(layers.MaxPooling2D((2, 2)))
...
def generate_child(model1, model2, tesnsor_size, layers_info):
    child_weights = crossingover2(model1, model2)
