...
def generate_model(input_size):
    ...
    model.add(layers.Conv2D(32, (5, 5), activation='relu', input_shape=input_size, strides=(2, 2), padding='valid'))
...
def mutation1(weights, num_weights, mutation_value):
